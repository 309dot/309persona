...
- [ ] 시스템 프롬프트/가드레일 노출 요구("system prompt", "시스템 메시지") 시 차단 메시지 출력
- [ ] 도메인 외 질문 시 `프로덕트/UX/경력 맥락으로 다시 질문` 안내 문구 노출
- [ ] 컨텍스트 블록에 Speaking Style, QA Templates, Guardrails 섹션이 포함되어 응답 품질에 반영되는지 확인
